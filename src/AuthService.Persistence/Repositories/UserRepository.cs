...
public class UserRepository(ApplicationDbContext context) : IUserRepository
{
    ...
    //2. Busca un usuario por su Email (sin importar mayusculas/minusculas)
    ...
    //3. Busca un usuario por su username (sin importar mayusculas/minusculas)
    ...
    // 4. Busca un usuario meditante su token de verificacion de email
    ...
    // 6. Crea un nuevo registro de usuario en la BD y lo retorna con sus relacioens
